...
class Coinbase {
    ...
    public static function withApiKey($uri, $key, $secret) {
        self::$_uri = $uri;
    ...
    public function createButtonWithOptions($options = array()) {
        ...
        $returnValue->codigo = $response->button->code;
        $returnValue->embedHtml = "<div class=\"coinbase-button\" data-code=\"" . $response->button->code . "\" data-button-style=\"none\"></div><script src=\"". \Bongo\Util\Server::getStatic()."static/js/coinbase-button.js\" type=\"text/javascript\"></script>";
